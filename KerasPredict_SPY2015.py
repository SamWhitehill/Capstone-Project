...
numFeatures =len(lstCols)
trainX, trainY = fnGetStockData(lstrPath+lstrStock+'dfQuotes2015.csv',40, look_back, horizon,lstCols)
testX, testY = fnGetStockData(lstrPath+lstrStock+'dfQuotesTest2015.csv',40, look_back, horizon,lstCols)
