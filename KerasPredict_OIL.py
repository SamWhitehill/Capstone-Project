...
lstCols =['2DayNetPriceChange','CloseSlope','rollingMean20','Adj Close','Volume','MACD',#'upper_band','lower_band',
             'High','Low','rollingStdev20','rollingMax20','rollingMin20']
numFeatures =len(lstCols)
trainX, trainY = fnGetStockData(lstrPath+lstrStock+'dfQuotes.csv',40, look_back, horizon,lstCols)
testX, testY = fnGetStockData(lstrPath+lstrStock+'dfQuotesTest.csv',40, look_back, horizon,lstCols)
...
batch_size = 1 #look_back*3 #*5 #1 tried increasing batch, worse fit for batch_size=1
